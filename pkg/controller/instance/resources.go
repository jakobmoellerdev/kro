...
func (c *Controller) processNode(
	...
	if err != nil {
		...
		rcx.StateManager.SetNodeState(id, NodeState{State: v1alpha1.NodeStateError, Err: err})
		return nil, err
	}
	if ignored {
		rcx.StateManager.SetNodeState(id, NodeState{State: v1alpha1.NodeStateSkipped})
