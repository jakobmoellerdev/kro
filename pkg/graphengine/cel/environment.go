...
func TypedEnvironmentWithIDsAndProvider(schemas map[string]*spec.Schema, dynIDs []string) (*cel.Env, *DeclTypeProvider, error) {
	return defaultEnvironment(WithTypedResources(schemas), WithResourceIDs(dynIDs))
}
